...
@test_run_time
def main(lock=None, start_num=None, end_num=None):
...
class MyThread(threading.Thread):
    def __init__(self, group=None, target=None, name=None,
        ...
        # self.args = threading.Lock()

if __name__ == '__main__':
    lock = threading.Lock()
    t1 = MyThread(target=main, name="线程1", args=(lock, 1, 20))
    t1.start()
    t2 = MyThread(target=main, name="线程2", args=(lock, 21, 40))
    t2.start()